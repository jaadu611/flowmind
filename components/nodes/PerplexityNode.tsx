...
export const PerplexityNode: React.FC<PerplexityNodeProps> = ({
  ...
  const [acceptImports, setAcceptImports] = useState(
    data.acceptImports ?? true,
  );
        ...
        <div className="border-t border-gray-800 p-[10px_12px] flex flex-col gap-[10px]">
          ...
          <div className="flex flex-col gap-3 border-t border-gray-800/30 pt-4 mt-2">
            ...
            {targetConnections.length > 0 && acceptImports && (
              <div className="flex justify-between items-center bg-[#0e1828] rounded p-[4px_8px] text-[10px] text-blue-400 border border-blue-900/50 mb-1">
                <span className="truncate flex-1 italic">
                  Accepting imports from previous node
                </span>
                <button
                  onClick={() => {
